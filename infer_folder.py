...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/infer_batch")
    ...
    img_files = sorted(img_files)[:args.limit]
    ...
    for img_path in img_files:
        ...
        orig_img, img_arr, orig_size = load_image(img_path, image_size=image_size)
        ...
        if mask_dir is not None:
            ...
            if gt_path.exists():
                gt_mask = load_mask(gt_path, image_size=image_size)
